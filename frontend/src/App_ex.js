...
class App extends Component {
  ...
  //Rendering all item in the list (completed || incompleted)
  renderItems = () => {
  ...
  render(){
    return (
      <main className="context p-3 mb-2 bg-info">
        <h1 className="text-white text-uppercase text-center my-4">Task Management</h1>
        <div className="row">
        ...
        Copy right 2021 &copy; All right reserved
        </footer>
