...
class Project(models.Model):
    ...
    created_by = models.ForeignKey('auth.User', related_name='project', on_delete=models.DO_NOTHING)
...
class Task(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    created_by = models.ForeignKey('auth.User', related_name='task', on_delete=models.DO_NOTHING)
    updated_at = models.DateTimeField(auto_now=True)
...
class Subtask(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    created_by = models.ForeignKey('auth.User', related_name='subtask', on_delete=models.DO_NOTHING)
    updated_at = models.DateTimeField(auto_now=True)
...
class Comment(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    created_by = models.ForeignKey('auth.User', related_name='comment', on_delete=models.DO_NOTHING)
    updated_at = models.DateTimeField(auto_now=True)
